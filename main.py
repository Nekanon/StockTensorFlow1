...
def experimentQL():
    ...
    dif_streams1 = [
                ...
                ("WFCOLD", "High", "Open", 0),
                ("WFCOLD", "Low", "Open", 0),
                ("WFCOLD", "Close", "Close", 1),
                ("WFCOLD", "Low", "Low", 1),
                ("WFCOLD", "High", "High", 1),
                ("WFCOLD", "Volume", "Volume", 0),
                ]
    ...
    #get encoder
    encoder, decoder, autoencoder = abm.getAutoencoder(input_data=(dif_data, dif_test), encod_count=int(window * 2.0), window=window)
